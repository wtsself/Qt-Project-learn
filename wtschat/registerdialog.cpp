    ...
    ui(new Ui::RegisterDialog),_countdown(5)
{
    ...
    connect(ui->comfirm_visible, &ClickedLabel::clicked, this, [this]() {
...
void RegisterDialog::initHttpHandlers()
{
    ...
    _handlers.insert(ReqId::ID_REG_USER, [this](QJsonObject jsonObj){
        ...
        ChangeTipPage();
        qDebug()<< "success register email is " << email ;
    });
...
bool RegisterDialog::checkPassValid()
{
    ...
    if(ui->confirm_lineEdit->text()!=""&&ui->pass_lineEdit->text()!=ui->confirm_lineEdit->text()){
        AddTipErr(TipErr::TIP_PWD_ERR, tr("确认密码不一致"));
        return false;;
...
bool RegisterDialog:: checkConfirmValid()
{
    ...
    if(ui->pass_lineEdit->text()!=""&&ui->confirm_lineEdit->text()!=ui->pass_lineEdit->text()){
